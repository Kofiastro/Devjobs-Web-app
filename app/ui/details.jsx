    ...
    <div className='  relative mx-[24px] md:mx-[40px] lg:mx-auto max-w-3xl flex-col justify-center items-center '>
      ...
      <div className='relative  mx-auto bg-White w-full p-[43px] mt-[32px]'>
        <div className='flex items-center justify-between '>
          ...
          <div>
            {/* Button */}
            <button className='bg-Violet font-semibold flex rounded-lg  md:text-md mx-auto lg:text-lg text-White  py-[16px] px-[20px] '>
              Apply Now
            </button>
          </div>
        </div>
        {/* Job Description */}
        <div>
          <h1 className='text-DarkGrey antialiased font-light py-[40px]'>
        ...
        <div className='flex flex-col '>
          <h1 className='font-bold text-xl text-VeryDarkBlue pb-[28px]'>Requirements</h1>
          <h1 className='text-DarkGrey font-light antialiased pb-[24px]'>
          ...
          <ul className='list-disc font-light text-DarkGrey antialiased space-y-[8px] '>
