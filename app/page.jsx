  ...
  return (
    <main className='bg-LightGray h-dvh'>
      ...
      <section>
        ...
        {/* FIlter and search  section a */}
        <div className=' relative flex justify-between mx-[24px] bg-White rounded-lg h-[80px] -mt-9 md:-mt-2 md:mx-[39px] lg:-mt-8 lg:mx-[165px] '>
          <input
            type='text'
            className='pl-[24px] text-Grey ring-0 rounded-lg focus:ring-0 focus:outline-none focus:border-none'
            placeholder='Filter by title…'
          />
          {/* search and filter BUtton */}
          <div className=" relative flex justify-center items-center space-x-[24.03px] mx-auto mr-[16px] ">
            ...
            <Image src={'/mobile/icon-search.svg'} width={19.95} height={19.95} className=''/>
            </div>
